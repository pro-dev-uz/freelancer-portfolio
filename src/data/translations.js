...
export const strings = {
  uz: {
    ...
    // Hero
    'hero.badge': 'Software Development Studio',
    'hero.title1': 'Biznesingizni',
    'hero.title2': 'Keyingi Bosqichga',
    'hero.title3': 'Olib Chiqing',
    'hero.subtitle': "G'oyangizni haqiqatga aylantiramiz — tez, sifatli va professional",
    ...
    'about.title1': 'Biz',
    'about.title2': 'Kimmiz?',
    'about.subtitle': 'Professional dasturchilar jamoasi — zamonaviy texnologiyalar bilan sifatli yechimlar yaratamiz',
    'about.p1': "DevPro — 3 yildan ortiq tajribaga ega professional dasturchilar jamoasi. Asosan",
    'about.p1_tg': 'Telegram botlar',
    'about.p1_web': 'web ilovalar',
    'about.p1_and': 'Android ilovalar',
    'about.p1_end': "yaratish bo'yicha ixtisoslashganmiz.",
    'about.p2': "Har bir loyihaga individual yondashuv — sizning biznesingiz uchun eng yaxshi yechimni taklif qilamiz. Sifat, tezkorlik va ishonchlilik — bizning asosiy tamoyillarimiz.",
    ...
    'contact.subtitle': "G'oyangiz bormi? Bizga yozing — bepul maslahat va narx taklifi olasiz",
    'contact.tg_desc': 'Eng tez aloqa usuli',
    'contact.ig_desc': 'Ishlarimiz va portfolio',
    'contact.tg_action': 'Yozish',
    'contact.ig_action': 'Ochish',
    'contact.copy_tg': 'Telegram username nusxalash',
    'contact.copied': 'Nusxalandi',
    'contact.why_title': 'Nima uchun biz?',
    ...
    'contact.why3_desc': "Loyiha jarayonida doimo xabar berib turamiz. Savollaringizga tezda javob olasiz.",
  ...
  ru: {
    ...
    'hero.title3': 'Уровень',
    'hero.subtitle': 'Воплотим вашу идею в реальность — быстро, качественно и профессионально',
    ...
    'about.title1': 'Кто',
    'about.title2': 'Мы?',
    'about.subtitle': 'Команда профессиональных разработчиков — создаём качественные решения с современными технологиями',
    'about.p1': 'DevPro — команда разработчиков с опытом более 3 лет. Специализируемся на создании',
    'about.p1_tg': 'Telegram ботов',
    'about.p1_web': 'веб-приложений',
    'about.p1_and': 'Android приложений',
    'about.p1_end': '.',
    'about.p2': 'Индивидуальный подход к каждому проекту — предложим лучшее решение для вашего бизнеса. Качество, скорость и надёжность — наши главные принципы.',
    ...
    'contact.subtitle': 'Есть идея? Напишите нам — получите бесплатную консультацию и предложение цены',
    'contact.tg_desc': 'Самый быстрый способ связи',
    'contact.ig_desc': 'Наши работы и портфолио',
    'contact.tg_action': 'Написать',
    'contact.ig_action': 'Открыть',
    'contact.copy_tg': 'Скопировать username',
    'contact.copied': 'Скопировано',
    'contact.why_title': 'Почему мы?',
    ...
    'contact.why3_desc': 'Всегда информируем о ходе проекта. Быстро отвечаем на ваши вопросы.',
  ...
  en: {
    ...
    'hero.title3': 'Level',
    'hero.subtitle': "We turn your ideas into reality — fast, professional and reliable",
    ...
    'about.title1': 'Who',
    'about.title2': 'We Are',
    'about.subtitle': 'Professional development team — creating quality solutions with modern technologies',
    'about.p1': "DevPro is a development team with over 3 years of experience. We specialize in creating",
    'about.p1_tg': 'Telegram bots',
    'about.p1_web': 'web applications',
    'about.p1_and': 'Android apps',
    'about.p1_end': '.',
    'about.p2': 'Individual approach to every project — we offer the best solution for your business. Quality, speed, and reliability — our core principles.',
    ...
    'contact.subtitle': 'Have an idea? Write to us — get a free consultation and price quote',
    'contact.tg_desc': 'Fastest way to reach us',
    'contact.ig_desc': 'Our work and portfolio',
    'contact.tg_action': 'Message',
    'contact.ig_action': 'Open',
    'contact.copy_tg': 'Copy Telegram username',
    'contact.copied': 'Copied',
    'contact.why_title': 'Why choose us?',
    ...
    'contact.why3_desc': 'We keep you updated on project progress. Quick answers to your questions.',
...
const servicesText = {
  uz: [
    ...
    { title: 'Telegram Xizmatlari', description: "Telegram Stars integratsiyasi va Premium xizmatlar — kontentni monetizatsiya, to'lov tizimi va maxsus imkoniyatlar", features: ["Stars to'lov tizimi", 'Premium hadya & kontent', 'Obuna tizimi', 'Premium bot'] },
  ...
  ru: [
    ...
    { title: 'Telegram Услуги', description: 'Интеграция Telegram Stars и Premium услуги — монетизация контента, платёжная система и особые возможности', features: ['Система оплаты Stars', 'Премиум подарки & контент', 'Система подписки', 'Премиум бот'] },
  ...
  en: [
    ...
    { title: 'Telegram Services', description: 'Telegram Stars integration and Premium services — content monetization, payment system and special capabilities', features: ['Stars payment system', 'Premium gifts & content', 'Subscription system', 'Premium bot'] },
...
const processText = {
  uz: [
    ...
    { step: '02', title: 'Tahlil & Reja', description: "Loyihani tahlil qilib, aniq muddat va bajariladigan ishlar ro'yxatini taklif qilamiz.", duration: '1 kun' },
    { step: '03', title: 'Ishga Tushish', description: "Kelishilgandan so'ng darhol ishni boshlaymiz. Progress haqida xabar berib turamiz.", duration: '1-10 kun' },
    { step: '04', title: 'Topshirish', description: 'Tayyor loyihani test qilib topshiramiz. 30 kun bepul tuzatish kafolati.', duration: 'Tayyor!' },
  ],
  ru: [
    ...
    { step: '02', title: 'Анализ и план', description: 'Проанализируем проект и предложим точный план работ и сроки.', duration: '1 день' },
    { step: '03', title: 'Разработка', description: 'После согласования сразу начнём работу. Будем информировать о прогрессе.', duration: '1-10 дней' },
    { step: '04', title: 'Сдача', description: 'Протестируем и сдадим готовый проект. 30 дней бесплатной гарантии.', duration: 'Готово!' },
  ],
  en: [
    { step: '01', title: 'Reach Out', description: 'Write on Telegram — tell us your idea. Get a free consultation.', duration: '1 hour' },
    { step: '02', title: 'Analysis & Plan', description: "We'll analyze the project and offer an exact work plan and timeline.", duration: '1 day' },
    { step: '03', title: 'Development', description: "After agreement, we start immediately. We'll keep you updated on progress.", duration: '1-10 days' },
    { step: '04', title: 'Delivery', description: "We'll test and deliver the finished project. 30 days free warranty.", duration: 'Done!' },
  ],
};
...
const faqsText = {
  uz: [
    { question: "Buyurtma qancha vaqtda tayyor bo'ladi?", answer: "Oddiy loyihalar (bot, landing page) 1-2 kunda, murakkab loyihalar (web ilova, Android) 5-10 kunda tayyor bo'ladi. Aniq muddatni loyihani ko'rgandan keyin aytamiz." },
    ...
    { question: "Agar natija yoqmasa nima bo'ladi?", answer: "Har bir bosqichda natijani ko'rsatamiz va tasdiqlaysiz. Agar biror narsa yoqmasa, bepul qayta ishlaymiz. Mijoz mamnunligi — birinchi o'rinda." },
  ],
  ru: [
    { question: 'Сколько времени занимает выполнение заказа?', answer: 'Простые проекты (бот, лендинг) — 1-2 дня, сложные (веб-приложение, Android) — 5-10 дней. Точные сроки скажем после оценки проекта.' },
    ...
    { question: 'Что если результат не понравится?', answer: 'На каждом этапе показываем результат для утверждения. Если что-то не нравится — бесплатно переделаем. Удовлетворённость клиента — на первом месте.' },
  ],
  en: [
    { question: 'How long does an order take to complete?', answer: 'Simple projects (bot, landing page) take 1-2 days, complex projects (web app, Android) take 5-10 days. We\'ll give exact timeline after evaluating the project.' },
    ...
    { question: "What if I don't like the result?", answer: "We show results at each stage for approval. If something doesn't meet your expectations — we'll redo it for free. Client satisfaction comes first." },
  ],
};
